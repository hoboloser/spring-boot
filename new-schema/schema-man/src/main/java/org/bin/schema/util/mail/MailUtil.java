package org.bin.schema.util.mail;
...
public class MailUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		mail.setPassword("ecjdnaphoujzbfhf");
		...
		recipient.setMail("2577186321@qq.com");
		Recipient recipient2 = new Recipient();
		recipient2.setMail("hoboloser@outlook.com");
		Recipient recipient3 = new Recipient();
		recipient3.setMail("huangbin@zhicall.cn");
		toList.add(recipient3);
		toList.add(recipient2);
